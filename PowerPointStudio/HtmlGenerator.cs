...
//            "<body style=\"width: " + slide.backGround.css.width + "; height:" + slide.backGround.css.height + ";  margin: 0px;\">";
...
//                {
//                    headHtml = headHtml + DivAdded(shape.image.actualUrl, (float)Convert.ToDouble(shape.css.width.Replace("px", "")),
//                    (float)Convert.ToDouble(shape.css.height.Replace("px", "")), (float)Convert.ToDouble(shape.css.left.Replace("px", "")),
//                    (float)Convert.ToDouble(shape.css.top.Replace("px", "")), false, false, shape.css.rotation);
//                }
